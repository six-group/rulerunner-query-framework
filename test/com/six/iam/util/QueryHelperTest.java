...
public class QueryHelperTest
{
	...
	private final List<Object[]> resultSet1 = List.of(
			record("John", "Doe", asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1)),
			record("Hans", "Muster", asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2))
	);
	private final List<Object[]> resultSet2 = List.of(
			record(asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1)),
			record(asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2))
	);
	...
	public void test_regular_and_extended() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", "John").add("lastname", "Doe").add("logonId", "usr001")));
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", "Hans").add("lastname", "Muster").add("logonId", "usr002")));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_regular_and_all_extended() throws GeneralException
	{
		...
		var iterator = QueryHelper.search(context, Identity.class, queryOptions, "firstname, lastname,");
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "John").add("lastname", "Doe").add("logonId", "usr001").add("costcenter", COSTCENTER1)));
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "Hans").add("lastname", "Muster").add("logonId", "usr002").add("costcenter", COSTCENTER2)));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_regular_and_attributes() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "John").add("lastname", "Doe").add("attributes", asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1))));
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "Hans").add("lastname", "Muster").add("attributes", asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2))));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_regular_and_attributes_and_extended() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "John").add("lastname", "Doe").add("attributes", asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1)).add("logonId", "usr001")));
		assertThat("Incorrect data", iterator.next(), is(asMap("firstname", (Object) "Hans").add("lastname", "Muster").add("attributes", asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2)).add("logonId", "usr002")));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_extended_only() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("logonId", "usr001")));
		assertThat("Incorrect data", iterator.next(), is(asMap("logonId", "usr002")));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_multiple_extended_only() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1)));
		assertThat("Incorrect data", iterator.next(), is(asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2)));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
	...
	public void test_attributes_only() throws GeneralException
	{
		...
		// Assert
		assertThat("Incorrect data", iterator.next(), is(asMap("attributes", asMap("logonId", (Object) "usr001").add("costcenter", COSTCENTER1))));
		assertThat("Incorrect data", iterator.next(), is(asMap("attributes", asMap("logonId", (Object) "usr002").add("costcenter", COSTCENTER2))));
		assertThat("Too many rows", iterator.hasNext(), is(false));
	}
...
//		// Assert
//		assertThat("Incorrect data", iterator.next(), is(asMap("name", "usr001").add("identityorigin", "Company 1").add("department_nr", "00001")));
//		assertThat("Incorrect data", iterator.next(), is(asMap("name", "usr002").add("identityorigin", "Company 2").add("department_nr", "00002")));
//		assertThat("Too many rows", iterator.hasNext(), is(false));
//	}
}
