...
{
	private final Identity johnDoe = createIdentity("usr001", "John", "Doe", Literals.asDate("2022-04-07 16:49:13"));
	private final Identity hansMuster = createIdentity("usr002", "Hans", "Muster", Literals.asDate("2022-04-08 00:00:00"));
	...
	public void test_csv_output() throws IOException
	{
		...
		var expected1 = "\"logonid\",\"displayName\",\"signature\",\"startDate\"\n\"usr001\",\"John Doe\",,2022-04-07T16:49:13\n\"usr002\",\"Hans Muster\",,2022-04-08T00:00:00\n";
	...
	public void test_html_output() throws IOException
	{
		...
		var expected_1 = String.join("",
								   ...
								   "<tr><td>usr001</td><td>John Doe</td><td></td><td>2022-04-07 16:49:13</td></tr>",
								   "<tr><td>usr002</td><td>Hans Muster</td><td></td><td>2022-04-08 00:00:00</td></tr>",
								   "</tbody></table>"
		);
		var expected_2 = String.join("",
								   "<table><tbody>",
								   "<tr><th>logonid</th><td>usr001</td><td>usr002</td></tr>",
